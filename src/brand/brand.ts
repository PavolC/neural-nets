...
export const SERIES = {
   ...
   *  rather than as a link to a 404: for this series that is
   *  https://pavolc.github.io/moving-parts/, live once PavolC/moving-parts is
   *  public and its Pages source is set to GitHub Actions. */
