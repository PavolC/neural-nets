...
//
//   gn:v1:      the learner's work. Exported, imported, cleared by "forget
...
//   gn:backup:  a copy of the nine per-exercise documents taken once, when
...
//   gn:ui:      panel layout. Neither exported nor cleared: it belongs to the
//               machine, not to the work.

export const WORK = "gn:v1:";
export const BACKUP = "gn:backup:";
