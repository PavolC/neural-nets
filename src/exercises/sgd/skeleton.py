# The gradients come for free: the section just above this one measures them
# by nudging, which is slow but correct. Your job is the descent itself: one
# update step, then the loop over epochs and mini-batches.
#
...
#
#       idx = rng.permutation(n)          # samples 0..n-1, in random order
